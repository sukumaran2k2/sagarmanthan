...
export default function Tabs({ activeTab, setActiveTab }) {
  ...
  const handleItemClick = (label, subTitle) => {
    if (subTitle === 'Young Professionals') {
      if (label === 'Input Form') setActiveTab('YP Input Form');
      if (label === 'Reports') setActiveTab('YP Reports');
    } else if (subTitle === 'Consultant Appointment') {
      if (label === 'Input Form') setActiveTab('Consultant Input Form');
      if (label === 'Reports') setActiveTab('Consultant Reports');
    } else {
          ...
          {MENU_DATA.map((menu) => {
            ...
            const hasDropdown = menu.subcategories || menu.items;
             const isHrActiveTab = [
               ...
               'YP Input Form', 'YP Reports', 'Consultant Input Form', 'Consultant Reports'
             ].includes(activeTab);
