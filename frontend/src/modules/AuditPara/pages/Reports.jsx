...
export default function Reports({ rowData = [] }) {
  ...
  const rows = useMemo(() => {
    return wingsList.map((wing) => {
      const wingParas = rowData.filter(
  ...
  const colDefs = useMemo(() => [
    ...
    {
      headerName: 'Wing', field: 'wing', minWidth: 200, pinned: 'left',
      cellClass: (params) =>
    ...
    { headerName: 'No. of Audit Paras', field: 'total', minWidth: 160, cellClass: 'text-center font-bold text-slate-800 flex items-center justify-center border-r border-slate-100', valueFormatter: (params) => params.value || '' },
    { headerName: 'Received at Ministry', field: 'received', minWidth: 180, cellClass: 'text-center font-semibold text-slate-700 flex items-center justify-center border-r border-slate-100', valueFormatter: (params) => params.value || '' },
    { headerName: 'Comments Sought from Organisation', field: 'sought', minWidth: 280, cellClass: 'text-center font-semibold text-slate-700 flex items-center justify-center border-r border-slate-100', valueFormatter: (params) => params.value || '' },
    { headerName: 'Comments Received from organisation', field: 'receivedOrg', minWidth: 290, cellClass: 'text-center font-semibold text-slate-700 flex items-center justify-center border-r border-slate-100', valueFormatter: (params) => params.value || '' },
    { headerName: 'Under Clarification', field: 'clarification', minWidth: 175, cellClass: 'text-center font-semibold text-slate-700 flex items-center justify-center border-r border-slate-100', valueFormatter: (params) => params.value || '' },
    { headerName: 'Comments Furnished to CAG', field: 'cag', minWidth: 220, cellClass: 'text-center font-semibold text-slate-700 flex items-center justify-center border-r border-slate-100', valueFormatter: (params) => params.value || '' },
    { headerName: 'Accepted by CAG', field: 'accepted', minWidth: 165, cellClass: 'text-center font-semibold text-slate-700 flex items-center justify-center border-r border-slate-100', valueFormatter: (params) => params.value || '' },
    { headerName: 'Dropped', field: 'dropped', minWidth: 120, cellClass: 'text-center font-semibold text-slate-700 flex items-center justify-center border-r border-slate-100', valueFormatter: (params) => params.value || '' }
  ], []);
