...
const ROW_DATA = [
  ...
  { sno: 6,  moduleName: 'VIP Reference',                        shipping: '22-06-2026',    vigilance: '--',           ports: '15-06-2026',  iwt: '29-05-2026',  admin: '--',          coordI: '--',           coordII: '--',          dgll: '--',           dev: '--',          finance: '--',          sagarmala: '--',       it: '--',  special: '--' },
  ...
  { sno: 9,  moduleName: 'Audit Para',                           shipping: '--',            vigilance: '--',           ports: '11-06-2026',  iwt: '--',          admin: '--',          coordI: '--',           coordII: '--',          dgll: '--',           dev: '--',          finance: '--',          sagarmala: '--',       it: '--',  special: '--' },
  ...
  { sno: 13, moduleName: 'Parliamentary Issues',                 shipping: '26-02-2026',    vigilance: '--',           ports: '06-04-2026',  iwt: '06-12-2024',  admin: '09-03-2026',  coordI: '--',           coordII: '--',          dgll: '--',           dev: '--',          finance: '--',          sagarmala: '--',       it: '--',  special: '24-03-2026' },
  ...
  { sno: 20, moduleName: 'Media Outreach',                       shipping: '--',            vigilance: '--',           ports: '18-05-2026',  iwt: '--',          admin: '--',          coordI: '--',           coordII: '--',          dgll: '--',           dev: '--',          finance: '--',          sagarmala: '--',       it: '--',  special: '--' },
];
