...
export default function TimeVoyageOffshoreReports() {
  ...
  const handleExport = (type) => {
    if (type === 'Excel' && gridRef.current?.api) gridRef.current.api.exportDataAsCsv({ fileName: 'sci_time_voyage_offshore_report.csv' });
    else if (type === 'PDF') {
      exportReportToPdf({
        title,
        chartRoots: [],
  ...
  return (
    <div>
      ...
      <style dangerouslySetInnerHTML={{ __html: `
        .sci-time-voyage-offshore-report-grid.ag-theme-quartz { --ag-font-family: 'Inter', system-ui, sans-serif; --ag-row-height: 48px; --ag-active-color: #4b2424; }
        .sci-time-voyage-offshore-report-grid .ag-root-wrapper { border: none !important; border-radius: 0 !important; }
        .sci-time-voyage-offshore-report-grid .ag-header { background: #4b2424 !important; border-bottom: 2px solid #3a1a1a !important; }
        .sci-time-voyage-offshore-report-grid .ag-header-cell { color: #ffffff !important; font-weight: 600 !important; font-size: 11px !important; text-transform: uppercase !important; letter-spacing: 0.05em !important; border-right: 1px solid rgba(255,255,255,0.15) !important; }
        .sci-time-voyage-offshore-report-grid .ag-header-cell-label { justify-content: center !important; }
        .sci-time-voyage-offshore-report-grid .ag-row-even { background: #ffffff !important; }
        .sci-time-voyage-offshore-report-grid .ag-row-odd { background: #f8faf6 !important; }
        .sci-time-voyage-offshore-report-grid .ag-cell { border-right: 1px solid #D3D6D9 !important; }
        .dark .sci-time-voyage-offshore-report-grid .ag-header { background: #0f172a !important; }
        .dark .sci-time-voyage-offshore-report-grid .ag-row-even { background: #090d16 !important; }
