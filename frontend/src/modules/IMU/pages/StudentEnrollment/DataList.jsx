...
export default function StudentEnrollmentDataList({
  ...
  const colDefs = useMemo(() => [
    ...
    ...(visibleCols.no_of_seats ? [{ headerName: 'Number Of Student Seats/Capacity', field: 'no_of_seats', flex: 1.2, minWidth: 200, cellClass: 'text-center text-slate-700 dark:text-slate-200 flex items-center justify-center font-semibold border-r border-slate-100 dark:border-slate-700' }] : []),
    ...(visibleCols.no_of_students_enrolled ? [{ headerName: 'Number Of Students Enrolled', field: 'no_of_students_enrolled', flex: 1.2, minWidth: 190, cellClass: 'text-center text-slate-700 dark:text-slate-200 flex items-center justify-center font-semibold border-r border-slate-100 dark:border-slate-700' }] : []),
    ...(visibleCols.percentage_of_student_admission ? [{ headerName: '% of Admission', field: 'percentage_of_student_admission', flex: 1, minWidth: 140, cellClass: 'text-center text-slate-700 dark:text-slate-200 flex items-center justify-center font-semibold border-r border-slate-100 dark:border-slate-700', valueFormatter: (p) => p.value != null ? `${p.value}%` : '' }] : []),
    ...(visibleCols.no_of_students_on_roll ? [{ headerName: 'Number of Students on Roll', field: 'no_of_students_on_roll', flex: 1.2, minWidth: 190, cellClass: 'text-center text-slate-700 dark:text-slate-200 flex items-center justify-center font-semibold border-r border-slate-100 dark:border-slate-700' }] : []),
    ...(visibleCols.no_of_final_year_students ? [{ headerName: 'Total No. of Final Year Students', field: 'no_of_final_year_students', flex: 1.2, minWidth: 200, cellClass: 'text-center text-slate-700 dark:text-slate-200 flex items-center justify-center font-semibold border-r border-slate-100 dark:border-slate-700' }] : []),
    ...(visibleCols.no_of_students_passedout ? [{ headerName: 'Total Number of Students Passed out', field: 'no_of_students_passedout', flex: 1.3, minWidth: 220, cellClass: 'text-center text-slate-700 dark:text-slate-200 flex items-center justify-center font-semibold border-r border-slate-100 dark:border-slate-700' }] : []),
    ...(visibleCols.no_of_students_placed ? [{ headerName: 'Number Of Students Placed', field: 'no_of_students_placed', flex: 1.2, minWidth: 190, cellClass: 'text-center text-slate-700 dark:text-slate-200 flex items-center justify-center font-semibold border-r border-slate-100 dark:border-slate-700' }] : []),
    ...(visibleCols.placement_percentage ? [{ headerName: 'Placement %', field: 'placement_percentage', flex: 1, minWidth: 130, cellClass: 'text-center text-slate-700 dark:text-slate-200 flex items-center justify-center font-semibold border-r border-slate-100 dark:border-slate-700', valueFormatter: (p) => p.value != null ? `${p.value}%` : '' }] : []),

    ...(canEdit || canRemove ? [{
      headerName: 'Actions', field: 'student_id', pinned: 'right', width: canEdit && canRemove ? 90 : 60,
