...
export default function ResearchDataList({
  ...
  const colDefs = useMemo(() => [
    ...
    ...(visibleCols.domestic_journals ? [{ headerName: 'Research Papers - Domestic Journals', field: 'domestic_journals', flex: 1.3, minWidth: 220, cellClass: 'text-center text-slate-700 dark:text-slate-200 flex items-center justify-center font-semibold border-r border-slate-100 dark:border-slate-700' }] : []),
    ...(visibleCols.international_journals ? [{ headerName: 'Research Papers - International Journals', field: 'international_journals', flex: 1.3, minWidth: 240, cellClass: 'text-center text-slate-700 dark:text-slate-200 flex items-center justify-center font-semibold border-r border-slate-100 dark:border-slate-700' }] : []),
    ...(visibleCols.phd_awarded ? [{ headerName: 'PhDs Awarded', field: 'phd_awarded', flex: 1, minWidth: 140, cellClass: 'text-center text-slate-700 dark:text-slate-200 flex items-center justify-center font-semibold border-r border-slate-100 dark:border-slate-700' }] : []),
    ...(visibleCols.patents_filed ? [{ headerName: 'Patents/IP Filed', field: 'patents_filed', flex: 1, minWidth: 160, cellClass: 'text-center text-slate-700 dark:text-slate-200 flex items-center justify-center font-semibold border-r border-slate-100 dark:border-slate-700' }] : []),
    ...(visibleCols.startups_funded ? [{ headerName: 'Startups Funded/Incubated', field: 'startups_funded', flex: 1.2, minWidth: 200, cellClass: 'text-center text-slate-700 dark:text-slate-200 flex items-center justify-center font-semibold border-r border-slate-100 dark:border-slate-700' }] : []),
    ...(visibleCols.research_ms_awarded ? [{ headerName: 'MS (By Research) Awarded', field: 'research_ms_awarded', flex: 1.2, minWidth: 200, cellClass: 'text-center text-slate-700 dark:text-slate-200 flex items-center justify-center font-semibold border-r border-slate-100 dark:border-slate-700' }] : []),

    ...(canEdit || canRemove ? [{
      headerName: 'Actions', field: 'research_id', pinned: 'right', width: canEdit && canRemove ? 90 : 60,
