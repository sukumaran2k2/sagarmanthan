...
const MODULE_CODE = 'YOUNG_PROFESSIONAL';

/**
 * Custom Hook for Young Professionals Permissions
 * Extracts User Matrix CRUD privileges & view scope parameters from JWT claims.
 */
export function useYpPermissions() {
