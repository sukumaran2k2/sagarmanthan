...
export default function VTMSIntegrationDataList({
  ...
  const colDefs = useMemo(() => [
    ...
    { headerName: 'Number of Ports VTMS System Integrated', field: 'no_of_ports_vtms_integrated', flex: 2, minWidth: 220, cellClass: 'text-center text-slate-700 dark:text-slate-200 flex items-center justify-center font-semibold border-r border-slate-100 dark:border-slate-700' },

    ...(canEdit || canRemove ? [{
      headerName: 'Actions', field: 'vtms_id', width: canEdit && canRemove ? 90 : 60,
      ...
      <div className="flex flex-row items-center gap-3">
        ...
        {canAdd && (
          ...
          >
            ...
            <span>Add VTMS Integration</span>
          </button>
        )}
      </div>
