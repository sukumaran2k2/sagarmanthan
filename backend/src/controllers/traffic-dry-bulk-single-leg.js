...
export async function getDryBulkSingleLeg(req, res) {
    ...
    const query = `
            ...
            FROM (
                ...
                WHERE 
                    cd.commodity_group_id = 2
                    AND cd.commodity_subcategory_id IN (18, 9, 10, 11, 12, 13, 14, 15, 16, 17, 19, 20, 21, 22, 29)
