...
async function capexReportData (req, res) 
{
    ...
    try 
    {
        ...
        FROM
            dbo.mmt_organisation
        LEFT JOIN
            dbo.tbl_capex ON mmt_organisation.organisation_id = tbl_capex.capex_organisation_id AND (tbl_capex.capex_financial_year = @selectedYear)
        LEFT JOIN
            dbo.tbl_capex_monthly ON tbl_capex.capex_id = tbl_capex_monthly.capex_id
        WHERE
