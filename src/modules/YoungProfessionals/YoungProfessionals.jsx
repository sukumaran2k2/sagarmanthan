...
export default function YoungProfessionalsView({ activeSubTab, setActiveSubTab, triggerNotification }) {
  ...
  const SUB_TABS = [
    { id: 'YP Input Form', label: 'Input Forms', icon: FileEdit },
    { id: 'YP Reports', label: 'Report', icon: FilePieChart }
  ];
        ...
        <div className="fixed inset-0 z-50 overflow-y-auto bg-slate-900/65 px-4 py-10">
          <div className="bg-white border border-slate-200 rounded-2xl shadow-2xl w-full max-w-lg mx-auto animate-scale-up">
            ...
            <div className="flex items-center justify-between border-b border-slate-100 px-7 pt-7 pb-5">
              <div>
                <h3 className="text-base font-extrabold text-slate-800 font-display">Add Young Professionals</h3>
                <p className="text-xs text-slate-500 font-medium mt-0.5">Create a new post and register details.</p>
              </div>
              <button
            ...
            {/* Modal Form */}
            <form onSubmit={handleAddPostSubmit} className="px-7 pt-5 pb-7 space-y-5">
              ...
              <div className="space-y-5 bg-slate-50 p-5 rounded-xl border border-slate-100">
                <div>
                  <label className="block text-xs font-bold text-slate-700 mb-1.5 uppercase tracking-wide">Date of Appointment *</label>
                  <div className="relative">
                    <input
                      ...
                      required
                      className="w-full text-xs pl-9 pr-3.5 py-2.5 bg-white border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-100 focus:border-blue-500 font-medium text-slate-700"
                    />
                ...
                <div>
                  <label className="block text-xs font-bold text-slate-700 mb-1.5 uppercase tracking-wide">Candidate Details (Resume/CV) *</label>
                  <div className="relative">
                    <input
                      type="file"
                      accept=".pdf,.doc,.docx"
